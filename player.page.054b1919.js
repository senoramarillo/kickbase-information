import{r as u,s as v,t as c,e as p,n as h}from"./chunks/point-formatter.e755dd0c.js";import{b as g,$ as m}from"./chunks/lit-html.154a0938.js";import{i as y}from"./chunks/player-points.03407b83.js";import{e as f,i as b,t as w}from"./chunks/directive.7cba340f.js";import{n as k,p as S,P as I}from"./chunks/player-status.41319264.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const d=f(class extends b{constructor(r){var e;if(super(r),r.type!==w.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var s,o;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!(!((s=this.st)===null||s===void 0)&&s.has(a))&&this.nt.add(a);return this.render(e)}const t=r.element.classList;this.nt.forEach(a=>{a in e||(t.remove(a),this.nt.delete(a))});for(const a in e){const n=!!e[a];n===this.nt.has(a)||((o=this.st)===null||o===void 0?void 0:o.has(a))||(n?(t.add(a),this.nt.add(a)):(t.remove(a),this.nt.delete(a)))}return g}});class P{async getData(e,s="2335868"){const o=`https://api.better-kickbase.workers.dev/leagues/${s}/players/${e}/`,t=await fetch(o);if(!t.ok)throw new Error(`Failed to fetch data: ${t.status} ${t.statusText}`);return await t.json()}}const $=new P;function D(r){return{match:r.d,points:r.p,goals:r.g,assists:r.a,home:r.h,playtimeSeconds:r.sp,startingEleven:r.ms,homeTeamId:r.t1i,awayTeamId:r.t2i,homeTeamGoals:r.t1s,awayTeamGoals:r.t2s}}function T(r){return{points:r.p,appearances:r.mp,startingEleven:r.ms,matches:r.m.map(D),year:r.t}}class N{async getData(e){const s=`https://api.better-kickbase.workers.dev/players/${e}/points`,o=await fetch(s);return o.ok?{seasons:(await o.json()).s.map(T)}:(console.log(`request was not successful: 
      ${o.statusText}: ${o.status}
      `),{seasons:[]})}}const F=new N;function x(r){return{...r}}function U(r){return{day:new Date(r.d),homeTeamId:r.t1i,homeTeamName:r.t1n,homeTeamNameShort:r.t1y,awayTeamId:r.t2i,awayTeamName:r.t2n,awayTeamNameShort:r.t2y,match:r.md,points:0,playtimeSeconds:0,homeTeamGoals:-1,awayTeamGoals:-1}}class j{async getData(e,s="2335868"){const o=`https://api.better-kickbase.workers.dev/leagues/${s}/players/${e}/stats`,a=await(await fetch(o)).json();return{averagePoints:a.averagePoints,f:a.f,firstName:a.firstName,id:a.id,lastName:a.lastName,marketValue:a.marketValue,mvHigh:a.mvHigh,mvHighDate:new Date(a.mvHighDate),mvLow:a.mvLow,mvLowDate:new Date(a.mvLowDate),mvTrend:a.mvTrend,upcomingMatches:a.nm.map(U),number:a.number,points:a.points,position:a.position,profileUrl:a.profileUrl,seasons:a.seasons.map(x),status:a.status,teamCoverUrl:a.teamCoverUrl,teamId:a.teamId,teamUrl:a.teamUrl,userFlags:a.userFlags}}}const _=new j;class A{async getData(e){return{playerInfo:await $.getData(e),playerPoints:await F.getData(e),playerStats:await _.getData(e)}}}const E=new A,H=u`
  :root,
  * {
...
`;var O=Object.defineProperty,L=Object.getOwnPropertyDescriptor,l=(r,e,s,o)=>{for(var t=o>1?void 0:o?L(e,s):e,a=r.length-1,n;a>=0;a--)(n=r[a])&&(t=(o?n(e,s,t):n(t))||t);return o&&t&&O(e,s,t),t};let i=class extends v{playerName;playerId;serverJsonData;teamId;playerInfo;playerPoints;playerStats;static styles=[H,u`
      .upper-half {
        width: 100%;
        display: grid;
    ...
    `];async willUpdate(r){const e=!this.playerPoints;if(e){const{playerInfo:s,playerPoints:o,playerStats:t}=JSON.parse(this.serverJsonData);this.playerInfo=s,this.playerPoints=o,this.playerStats=t}if(e){const{playerInfo:s,playerPoints:o,playerStats:t}=await E.getData(this.playerId);this.playerInfo=s,this.playerPoints=o,this.playerStats=t}}get upperHalfStyles(){return{"background-color":`var(--team-primary-color-${this.teamId}, gray)`}}get colorFadeStyles(){return{background:`linear-gradient(to bottom, transparent, var(--team-primary-color-${this.teamId}, gray));`}}render(){return m`
