...
`;var O=Object.defineProperty,E=Object.getOwnPropertyDescriptor,l=(r,e,i,t)=>{for(var o=t>1?void 0:t?E(e,i):e,a=r.length-1,m;a>=0;a--)(m=r[a])&&(o=(t?m(e,i,o):m(o))||o);return t&&o&&O(e,i,o),o};let s=class extends u{playerName;playerId;serverJsonData;teamId;playerInfo;playerPoints;playerStats;static styles=[H,d`
      .upper-half {
        width: 100%;
        display: grid;
    ...
    `];async willUpdate(r){const e=!this.playerPoints;if(e){const{playerInfo:i,playerPoints:t,playerStats:o}=JSON.parse(this.serverJsonData);this.playerInfo=i,this.playerPoints=t,this.playerStats=o}if(e){const{playerInfo:i,playerPoints:t,playerStats:o}=await A.getData(this.playerId);this.playerInfo=i,this.playerPoints=t,this.playerStats=o}}get upperHalfStyles(){return{"background-color":`var(--team-primary-color-${this.teamId}, gray)`}}get colorFadeStyles(){return{background:`linear-gradient(to bottom, transparent, var(--team-primary-color-${this.teamId}, gray));`}}render(){return h`
      <div class="upper-half" style=${c(this.upperHalfStyles)}>
        ...
        <div class="player-summary">
          <div
            class=${y({"bottom-container":!0,inverted:this.playerInfo.teamName==="Dortmund"})}
          >
          ...
          <h1
            class=${y({"player-name":!0,inverted:this.playerInfo.teamName==="Dortmund"})}
          >
            ${this.playerName}
          </h1>
      ...
      ></bkb-player-points>
    `}priceTrendTemplate(r){switch(r){case 1:return"\u{1F815}";case 2:return"\u{1F817}";default:case 0:return"-"}}};l([n({type:String,attribute:"player-name"})],s.prototype,"playerName",2);l([n({type:String,attribute:"player-id"})],s.prototype,"playerId",2);l([n({type:String,attribute:"server-json-data"})],s.prototype,"serverJsonData",2);l([n({type:String,attribute:"team-id"})],s.prototype,"teamId",2);l([p()],s.prototype,"playerInfo",2);l([p()],s.prototype,"playerPoints",2);l([p()],s.prototype,"playerStats",2);s=l([v("bkb-player")],s);export{s as PlayerPage};
