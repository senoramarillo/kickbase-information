...
export class BundesligaTableService {
  ...
  private mockData(): BundesligaTable {
    const teams: BundesligaTableEntry[] = [
      ...
      { goadDifference: 0, matches: 0, points: 0, place: 18, teamId: '39', teamName: 'St. Pauli', trend: 0 },
      ...
      { goadDifference: 0, matches: 0, points: 0, place: 7, teamId: '51', teamName: 'Kiel', trend: 0 },
